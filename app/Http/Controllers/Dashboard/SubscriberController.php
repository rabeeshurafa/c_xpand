...

{
    ...
    public function getUserData (Request $request){
        ...
        $user['certCount'] =Cert::where('citizen_id',$request['subscribe_id'])->count();
        ...
        $user['ArchiveCount'] = $ArchiveCount + $CopyToCount +$ArchiveLicCount+$jalArchiveCount+$user['certCount'];
