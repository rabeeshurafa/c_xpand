...
class WaterTicketController extends Controller
{
    ...
    { 
        ...
        $app_no=1;
        return view('dashboard.water_ticket.subscription', compact('type','ticketInfo','department','subsList','region','app_type','fees','archive_config','app_no'));
    }
    ...
    public function waterLineDisconnect()
    {
        ...
        $archive_config = ArchiveRole::where('empid', Auth()->user()->id)->where('type', $type)->get();
        $app_no=6;
        return view('dashboard.water_ticket.disconnect', compact('type','ticketInfo','region','department','app_type','fees','archive_config','app_no'));
    }
    public function globalWaterMalfunction()
    {
        ...
        $archive_config = ArchiveRole::where('empid', Auth()->user()->id)->where('type', $type)->get();
        $app_no=4;
        return view('dashboard.water_ticket.globalMalfunction', compact('type','ticketInfo','department','region','app_type','fees','archive_config','app_no'));
    }
    public function waterMalfunction()
    {
        ...
        $archive_config = ArchiveRole::where('empid', Auth()->user()->id)->where('type', $type)->get();
        $app_no=2;
        return view('dashboard.water_ticket.malfunction', compact('type','ticketInfo','department','region','app_type','fees','archive_config','app_no'));
    }
    public function meterCheck()
    {
        ...
        $archive_config = ArchiveRole::where('empid', Auth()->user()->id)->where('type', $type)->get();
        $app_no=5;
        return view('dashboard.water_ticket.meterCheck', compact('type','ticketInfo','region','department','app_type','fees','archive_config','app_no'));
    }
    public function meterRead()
    {
        ...
        $archive_config = ArchiveRole::where('empid', Auth()->user()->id)->where('type', $type)->get();
        $app_no=9;
        return view('dashboard.water_ticket.meterRead', compact('type','region','ticketInfo','department','app_type','fees','archive_config','app_no'));
    }
    ...
    public function waterLineReconnect()
    {
        ...
        $archive_config = ArchiveRole::where('empid', Auth()->user()->id)->where('type', $type)->get();
        $app_no=7;
        return view('dashboard.water_ticket.reconnect', compact('type','region','ticketInfo','department','app_type','fees','archive_config','app_no'));
    }
    public function disconnect()
    {
        ...
        $fees=$this->fees;
        $archive_config = ArchiveRole::where('empid', Auth()->user()->id)->where('type', $type)->get();
        return view('dashboard.water_ticket.disconnect', compact('type','ticketInfo','region','department','app_type','fees','$archive_config'));
    }
    public function waiveSubscription ()
    {
        ...
        $archive_config = ArchiveRole::where('empid', Auth()->user()->id)->where('type', $type)->get();
        $app_no=8;
        return view('dashboard.water_ticket.waiveSubscription', compact('type','region','ticketInfo','department','app_type','fees','archive_config','app_no'));
    }
    public function meterTransfer()
    {
        ...
        $archive_config = ArchiveRole::where('empid', Auth()->user()->id)->where('type', $type)->get();
        $app_no=10;
        return view('dashboard.water_ticket.meterTransfer', compact('type','region','ticketInfo','department','app_type','fees','archive_config','app_no'));
    }
    public function waterFinancialTransfer()
    {
        ...
        $app_no=11;
        $archive_config = ArchiveRole::where('empid', Auth()->user()->id)->where('type', $type)->get();
        return view('dashboard.water_ticket.FinancialTransfer', compact('type','ticketInfo','department','app_type','fees','archive_config','app_no'));
    }
