...

{
    ...
    public function index(){
        ...
        $subscription_TypeData = Constant::where('parent',28)->where('status',1)->get();
        ...
        return view('dashboard.elec.elecAdd',compact('type','counter_TypeData','vasTypeData','payTypeData','subscription_TypeData'));    
...

    {
        ...
        $elec = elec::select('elecs.*', 'users.name as user_name','a.name as subscription_Type_name','b.name as counter_Type_name','c.name as vasType_name'
