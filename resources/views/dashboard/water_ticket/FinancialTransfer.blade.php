                                            ...
                                            <div class="form-group">
                                                <div class="input-group" style="width: 93% !important;">
                                                    ...
                                                    <input type="text" id="TransferAmount" name="TransferAmount"
                                                        class="form-control numFeild" placeholder="000"
                                                ...
                                                <div class=" input-group ">
                                                    <div class="input-group col-md-8" style="padding: 0px;">
                                                        ...
                                                        <input type="text" id="subscriber_name1"
                                                            class="form-control numFeild" placeholder="{{ 'اسم المشترك' }}"
                    ...
                    for(var i=0; i<len; i++){
                      $row+= 
                        ...
                        '<td>'+
                            ...
                            '<input type="hidden" name="SubscribtionIdList1[]" value="'+response.water[i].id+'"><input type="text" class="form-control form-control1 numFeild hide" name="SubscribtionNumList1[]" value="'+(response.water[i].licNo??'')+'">'+
                        '</td>'+
                        '<td class="hideMob" style="text-align: -webkit-center;">'+
                            (response.water[i].counter.name??'')+
                            '<input type="text" class="form-control form-control1 alphaFeild hide" name="CounterTypeList1[]" value="'+(response.water[i].counter.name??'')+'">'+
                        '</td>'+
                        '<td style="text-align: -webkit-center;">'+
                            (response.water[i].placeDesc??'')+
                            '<input type="text" class="form-control form-control1   hide" name="CapacityList1[]" value="'+(response.water[i].placeDesc??'')+'">'+
                        '</td>'+
                        '<td>'+
                            '<input type="radio" id="counters1" name="counters1" checked="" value="'+response.water[i].id+'" onclick="">'+
                        '</td>'+
                        '</tr>';
                    }
                    $("#recList1").append($row);
