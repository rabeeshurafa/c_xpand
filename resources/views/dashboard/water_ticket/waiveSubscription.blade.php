                ...
                <div class="col-sm-12 col-md-6">
                    <div class="card leftSide">
                        ...
                        <div class="card-content collapse show">
                            <div class="card-body" style="padding-bottom: 0px;">
                                <div class="form-body">
                                    ...
                                    <div class="row Acting @if(isset($ticket))
                                        {{ $ticket->ownership_type==1?"hide":"" }}
                                        @else
                                        @endif" style="@if(!isset($ticket)) position: relative; display: none; @endif"  id="Acting">
                                        <div class="col-md-7">
                                                    ...
                                                    @foreach($ticket->subscription as $subs)
                                                        <tr>
                                                            ...
                                                            <td>   
                                                                ...
                                                                <input type="text" class="form-control form-control1 numFeild hide" name="SubscribtionNumList[]" value="{{($subs->subscription_no??'')}}">
                                                            </td>
                        ...
                        <div class="form-group" style="padding-right: 25px;">
                            ...
                            @include('dashboard.includes.subscriber1')
                            
                            @include('dashboard.includes.regionsTemplate1')
                        </div>
          ...
          url: "{{route('appCustomer')}}",
           ...
           success: (response) => {
             if (response) {
                ...
                //         '<td style="color:#1E9FF2">'+(i+1)+'</td> '+
                //         '<td>'+
                //             (response.water[i].licNo??'')+
                //             '<input type="hidden" name="SubscribtionIdList[]" value="'+response.water[i].id+'"><input type="text" class="form-control form-control1 numFeild hide" name="SubscribtionNumList[]" value="'+(response.water[i].licNo??'')+'">'+
                //         '</td>'+
                //         '<td class="hideMob" style="text-align: -webkit-center;">'+
                //             (response.water[i].counter.name??'')+
                //             '<input type="text" class="form-control form-control1 alphaFeild hide" name="CounterTypeList[]" value="'+(response.water[i].counter.name??'')+'">'+
                //         '</td>'+
                //         '<td style="text-align: -webkit-center;">'+
                //             (response.water[i].placeDesc??'')+
                //             '<input type="text" class="form-control form-control1   hide" name="CapacityList[]" value="'+(response.water[i].placeDesc??'')+'">'+
