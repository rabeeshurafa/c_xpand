                                                ...
                                                <tbody id="recList">
                                                    ...
                                                    @foreach($ticket->subscription as $subs)
                                                        <tr>
                                                            ...
                                                            <td class="hidemob">
                                                                <input type="radio" id="counters" name="counters" checked="" value="{{($subs->id)}}" >
                                                            </td>
                                                        </tr>
                                                    @endforeach
                                                    @endif
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <div class="input-group licNoGroup" id="licGroup" style="width: 93% !important;">
                                            ...
                                            <input type="text" id="licNo" name="licNo" class="form-control eng-sm  valid" value="@if(isset($ticket)){{($ticket->licNo??'')}}@endif" placeholder="" autocomplete="off">
                                        </div>
                                    </div>
                                </div>
                            </div>
