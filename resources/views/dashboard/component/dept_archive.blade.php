                            ...
                            <div class="form-group">
                                ...
                                <div class="tab-content px-1 pt-1" style="margin-top:0px !important ;">
                                    ...
                                    <div class="tab-pane" id="ctab2" aria-labelledby="base-tab2">
                                        ...
                                        <table style="width:100%; margin-top: 10px;direction: rtl;" class="detailsTB table hdrTbl1 contracttbl" >
...
<script>
    ...
    function getContractArchive($id,$contractArchiveCount){
        ...
        var table = $('.contracttbl').DataTable({
            destroy: true,
            ajax: {
                url: '{{ route('deptContractArchive') }}',
                data: function (d) {
                    d.dept_id = $id;
                }
            },
    ...
    function getLawArchive($id,$lawArchiveCount){
            // let $orgnization_id;

        var table = $('.lawtbl').DataTable({
            destroy: true,
            ajax: {
                url: '{{ route('deptLawArchive') }}',
                data: function (d) {
                    d.dept_id = $id;
                }
            },
