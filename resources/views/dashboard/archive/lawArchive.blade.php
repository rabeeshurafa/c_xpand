                                                ...
                                                <div class="form-group paddmob">
                                                    ...
                                                    <div class="input-group ">
                                                        ...
                                                        {{-- @if($type=='projArchive'||$type=='munArchive'||$type=='empArchive'||$type=='depArchive'||$type=='assetsArchive'||$type=='citArchive') --}}
                                                            ...
                                                            <div class="input-group-append hidemob" onclick="ShowConstantModal(101,'archive_type','نوع الوثيقة')" style="cursor:pointer">
                                            ...
                                            <div class="col-md-6"  style="padding-left: 8px">
                                                ...
                                                <div class="form-group paddmob">
                                                    ...
                                                    <div class="input-group ">
                                                        ...
                                                        <input type="text" id="msgnote" name="msgnote" class="form-control  valid" style="text-align: right;direction: ltr;">
