        ...
        <div class="form-group" style="margin-bottom: 0rem!important;">
            <div class="input-group" style="width:100%!important;">
                ...
                <div class="col-sm-12 col-md-3">
                    <input type="radio" name="phase[]" checked="" id="radio-1" class="jui-radio-buttons" value="1" onclick="drawCosts1();">
                   
                    <label for="radio-1">1 فاز</label>
                    <input type="radio" name="phase[]" id="radio-2" class="jui-radio-buttons" value="2" onclick="drawCosts2();">
