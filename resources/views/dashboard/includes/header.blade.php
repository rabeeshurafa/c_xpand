        ...
        <ul class="nav navbar-nav mr-auto float-left">
          ...
          <li class="dropdown dropdown-user nav-item">
            ...
            <div class="dropdown-menu dropdown-menu-right">
              ...
              <a class="dropdown-item " href="{{route('empArchive')}}"><img src="{{asset('assets/images/archives.png')}}" style="height: 13px;"> أرشيف الموظف </a>
         ...
         @can('orgEmail')
          ...
          <li class="dropdown nav-item mega-dropdown">
            <a class="nav-link" href="#" data-toggle="dropdown" style="margin-top: 12px;color: black;" >
                مهامي
              
            </a>
            @include('dashboard.component.myTasksModel')
            {{--<span class="badge badge-pill badge-default badge-danger badge-default badge-up badge-glow" style="left: -20px;" id="tasksCount101"></span>--}}
          </li>
          <li class="dropdown dropdown-notification nav-item" style="margin-left: 14px;">
            <span class="badge badge-pill badge-default badge-danger badge-default badge-up badge-glow" onclick="/*$('#myTasksModel101').modal('show');*/" style="left: -13px;" id="tasksCount101"></span>
          </li>
          @endcan
          ...
          @can('showNotificationList') 
            <li class="dropdown dropdown-notification hidedesc-inline">
    			<a class="nav-link nav-link-label" href="#" data-toggle="dropdown" style="color: #000;margin-top: 11px;">
    			    قائمة الاشعارات
    			    <i class="fa fa-bell" style="font-size:18pt;"></i> 
    				<span class="badge badge-pill badge-default badge-danger badge-default badge-up badge-glow setAllAsRead notiCntr" id="setAllAsRead">0</span>
    			</a>
    			<ul class="dropdown-menu dropdown-menu-media dropdown-menu-right" style="width: 500px;">
    				<li class="scrollable-container media-list media-list1 ps-container ps-theme-dark noti_list" data-ps-id="a5a8fe69-1beb-3d41-c5b0-8fed8c88f654">
