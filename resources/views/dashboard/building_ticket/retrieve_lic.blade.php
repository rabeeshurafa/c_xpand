                                        ...
                                        <div class="col-md-6" style="padding-left: 5px">
                                            <div class="form-group">
                                                <div class="input-group w-s-87 mt-s-6">
                                                    ...
                                                    <input class="form-control" type="text" id="orginNo" name="orginNo"
                                                        class="form-control noleft" placeholder="{{ 'رقم الوصل الاصلى' }}"
                                                        aria-describedby="basic-addon1">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6 hideMob" style="padding-left: 26px;">
                                            <div class="form-group">
                                                <div class="input-group" style="padding-left: 23px;">
                                                    ...
                                                    <input class="form-control" type="text" id="licNo" name="licNo"
                                                        class="form-control noleft" placeholder="{{ 'رقم الرخصة' }}"
                                                        aria-describedby="basic-addon1">
                                                </div>
                                            </div>
                                        </div>
...
//               this.reset();
           ...
           error: function(response){
            ...
            if(response.responseJSON.errors.orginNo){
                $( "#orginNo" ).addClass( "error" );
                $( "#orginNo" ).get(0).setCustomValidity('يرجى ادخال الوصل الاصلي ');
                $( "#orginNo" ).on('input',function(){
                    this.setCustomValidity('')
                })
            }
