                                    ...
                                    <div class="row">
                                        <div class="col-md-4 col-sm-12" style="padding-left: 0px;">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group licNoGroup" id="licGroup" style="width: 100% !important;">
                                        ...
                                        <div class="col-md-4 col-sm-12" style="padding-left: 18px">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-4 col-sm-12 hideMob " style=" padding-right: 0px;">
                                            <div class="form-group">
             ...
             if (response) {
                ...
                else
                {
                        ...
                        Swal.fire({
            				position: 'top-center',
            				icon: 'error',
            				title: 'لا يمكن تقديم الطلب لعدم وجود رخص بناء معرفة في النظام',
            				showConfirmButton: true,
            				})
                }
