                                                ...
                                                <div class="col-lg-6 col-md-12 padding_right10" style="padding-left: 14px;">
                                                    <div class="form-group">
                                                        <div class="input-group w-s-87" style="">
                                                            <div class="input-group-prepend"> <spanclass="input-group-text input-group-text1" id="basic-addon1"> <imgsrc="https://db.expand.ps/images/w35.png"style="max-width: 35px;"> </span> </div> 
