                    ...
                    for(var i=0; i<len; i++){
                      ...
                      $row+= 
                        ...
                        '<td>'+
                            ...
                            '<input type="hidden" name="SubscribtionIdList1[]" value="'+response.elec[i].id+'"><input type="text" class="form-control form-control1 numFeild hide" name="SubscribtionNumList1[]" value="'+(response.elec[i].licNo??'')+'">'+
                        '</td>'+
                        '<td class="hideMob" style="text-align: -webkit-center;">'+
                            (response.elec[i].counter.name??'')+
                            '<input type="text" class="form-control form-control1 alphaFeild hide" name="CounterTypeList1[]" value="'+(response.elec[i].counter.name??'')+'">'+
                        '</td>'+
                        '<td style="text-align: -webkit-center;">'+
                            (response.elec[i].placeDesc??'')+
                            '<input type="text" class="form-control form-control1   hide" name="CapacityList1[]" value="'+(response.elec[i].placeDesc??'')+'">'+
                        '</td>'+
                        '<td>'+
                            '<input type="radio" id="counters1" name="counters1" checked="" value="'+response.elec[i].id+'" onclick="">'+
                        '</td>'+
                        '</tr>';
                    }
                    $("#recList2").append($row);
