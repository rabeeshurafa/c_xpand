                                                ...
                                                <div class="col-md-4 hide">
                                                    <div class="form-group">
                                                        <div class="input-group licNoGroup" style="width:99% !important;">
                                                            ...
                                                            <select id="CurrVas1" name="CurrVas1" class="form-control valid" aria-invalid="false" onchange=" ">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <div class="input-group licNoGroup" style="width:99% !important;">
                                                            ...
                                                            <input type="number" id="CurrAmpere1" name="CurrAmpere1" class="form-control numFeild" value="32" onblur=" " onchange=" ">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <div class="input-group licNoGroup" style="width:99% !important;">
                                                            ...
                                                            <input type="number" id="NewAmpere1" name="NewAmpere1" class="form-control numFeild NewAmpere1" value="32"  onblur=" " onchange=" ">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <div class="input-group licNoGroup" style="width:99% !important;">
                                                            ...
                                                            <select id="CurrVas" name="CurrVas" class="form-control valid" aria-invalid="false" onchange="changeVasTitle();">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <div class="input-group licNoGroup" style="width:99% !important;">
                                                            ...
                                                            <input type="number" id="CurrAmpere" name="CurrAmpere" class="form-control numFeild" value="32" >
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <div class="input-group licNoGroup" style="width:99% !important;">
                                                            ...
                                                            <input type="number" id="NewAmpere" name="NewAmpere" class="form-control numFeild NewAmpere" value="0" onblur="calcAmpereCost()" onchange="calcAmpereCost()">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
function changeVasTitle(){
    ...
    if($('#CurrVas').val()==42) {
        ...
        $('#ampereCost').val('{{$ampereCost1Vas}}');
    }else{
        $('.vasTitle').text('سعر الامبير 3 فاز');
        $('#ampereCost').val('{{$ampereCost3Vas}}');
    }
    calcAmpereCost();
}
...
function calcAmpereCost(){
    ...
    if($('#CurrAmpere').val() > $('#NewAmpere').val() || $('#CurrAmpere').val() == $('#NewAmpere').val()){
        Swal.fire({
				position: 'top-center',
				icon: 'error',
				title: 'الامبيرات الجديدة اقل من الحالية',
    ...
    ampereCount=$('#NewAmpere').val()-$('#CurrAmpere').val();
    $('#ampereCount').val(ampereCount);
    
   ampereTotalCost= $('#ampereCost').val()*ampereCount;
