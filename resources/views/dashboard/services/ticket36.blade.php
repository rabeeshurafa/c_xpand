                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="form-group" style="margin-bottom: 0rem!important;">
                                                            <div class="input-group" style="width:100%!important;">
                                                                ...
                                                                <div class="col-sm-12 col-md-3" @if ($type != 'elecSubscription')
                                                                    style="visibility: hidden;"
                                                                    @endif
                                                                    >
                                                                    <div class="float-left">
                                                                        <input type="number" class="form-control numFeild" style="width:60px;" name="inAmper"
                                                                            id="inAmper" value="32" placeholder="30 أمبير">
                                                                    </div> &nbsp;
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <div class="input-group" style="width:99% !important;">
                                                                ...
                                                                <input type="number" id="i_days" class="form-control" name="i_days" onchange="" >
