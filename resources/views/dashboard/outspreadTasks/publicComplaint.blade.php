                                            ...
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" id="subscriber_name"
                                                        ...
                                                        name="subscriber_name" @if(isset($ticket)) readonly  value="{{$ticket->customer_name}}"@endif>
                                                        
                                                    <input type="hidden" id="subscriber_id" name="subscriber_id"  @if(isset($ticket)) 
                                                        value="{{$ticket->customer_id}}"@else value="0" @endif>
                                            ...
                                            <div class="form-group">
                                                <div class="input-group" style="width: 97% !important; ">
                                                    ...
                                                    <input type="text" id="MobileNo" maxlength="10" name="MobileNo"
                                                        ...
                                                        onblur="$('#username').val($(this).val())" @if(isset($ticket))  value="{{$ticket->customer_mobile}}"@endif>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
